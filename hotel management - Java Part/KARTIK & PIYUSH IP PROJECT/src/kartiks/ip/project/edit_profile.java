    ...
    gender="F";
        ...
        JOptionPane.showMessageDialog(null, "All fields are mandatory.");
            ...
            try {
                ...
                String update_members= "update members set name='"+ name +"' , gender='"+gender+"' , password='"+password+"' where status='online';";
                    String update_contact_info= "update contact_info  set name='"+ name +"' , mobile_no="+mobile+" , email='"+email_id+"' , address='"+address+"' where status='online';";
                   String update_orders= "update orders set name='"+ name +"' where status='online';";
        ...
        if(mobile.equals("")){
            ...
            if(length==10){
                if(initial_digit==8|| initial_digit==9 || initial_digit==7){
                    String duplicate_check="select mobile_no from contact_info where mobile_no="+mobile+" and status='offline';";
                    try{
                       Class.forName("java.sql.Driver");
                Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/subway","root","123");
                        Statement stmt=con.createStatement();
